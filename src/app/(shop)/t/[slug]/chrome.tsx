...
export function WhatsAppButton({ phone, brandName }: { phone: string; brandName: string }) {
  // La ficha de producto monta una barra de compra fija al pie en móvil. El
  // botón se sube para no taparla: esa barra es lo que cierra la venta en
  // teléfono y no puede quedar detrás de nada.
  const pathname = usePathname();
  const overBuyBar = pathname.includes('/producto/');
